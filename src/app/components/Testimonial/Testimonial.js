          ...
          <Slider {...settings} className="cursor-all-scroll">
            ...
            <div className="slider-card flex" style={{ paddingLeft: "0px" }}>
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(5deg, #F59E0B 0 10%, white 0% 10%)",
                }}
              >
                <div className=" flex">
   ...
   */}
            ...
            <div className="slider-card flex" style={{ paddingLeft: "0px" }}>
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(5deg, #F59E0B 0 10%, white 0% 90%)",
                }}
              >
                <div className=" flex">
                  <div className="min-w-[100px]">
            ...
            <div className="slider-card flex" style={{ paddingLeft: "0px" }}>
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(5deg, #F59E0B 0 10%, white 0% 100%)",
                }}
              >
                <div className=" flex">
                  <div className="min-w-[100px]">
            ...
            <div className="slider-card flex" style={{ paddingLeft: "0px" }}>
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(4deg, #F59E0B 0 10%, white 0% 100%)",
                }}
              >
                <div className=" flex">
                  <div className="min-w-[100px]">
